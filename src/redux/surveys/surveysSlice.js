...
export const getSpeechCard = createAsyncThunk(
    ...
    async (childId, {rejectWithValue}) => {
        try {
            const resp = await axiosApi.get(`/charts/children/${childId}/speech-card/`)
            return resp.data
        } catch (e) {
...
export const createSpeechCard = createAsyncThunk(
    ...
    async ({childId, speechCardData}, {rejectWithValue}) => {
        try {
            await axiosApi.post(`/charts/children/${childId}/create-speech-card/`, speechCardData)
        } catch (e) {
            return rejectWithValue(e)
        }
    }
...
export const updateSpeechCard = createAsyncThunk(
    ...
    async ({speechCardId, speechCardData}, {rejectWithValue}) => {
        try {
            const resp = axiosApi.put(`/charts/speech-card/${speechCardId}/`, speechCardData)
            return  resp.data
        } catch (e) {
            return rejectWithValue(e)
        }
