...
import { getHumanizeAge, strDateToMoment } from 'utils/date/dateUtils.js';
import { dateNameOfMonth, domains, frontUrls } from 'constants.js';
import config from 'config.js';
import logo from '../../../assets/img/hellobiba_logo.png';
...
const SpeechCardView = forwardRef((props, ref) => {
  ...
  const getPageMargins = () => {
    return `@page { margin: 0.7in !important; }`;
  };
  console.log('[speechCard]', speechCard);
  return (
      <div style={{ margin: '0 auto' }} id='speech-card-view' ref={ref}>
        <div className='speech-card-doc'>
          <div className='speech-card-doc__head'>
            <div className='speech-card-doc__head-logo'>
              <img src={logo} alt='hellobiba'/>
            </div>
              ...
              <div className='count-list'>
                <div className='count-item speech-card-doc__item'>
                  ...
                  <div className='count-list'>
                    ...
                    <div className='count-item speech-card-doc__sub'>
                      <p>Речевая среда, в которой воспитывается ребенок (со слов
                        родителя): <span>{speechCard.speech_environment}</span></p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                    ...
                    <div className='count-item speech-card-doc__sub'>
                      <p>Медикаментозное лечение: <span>{speechCard.drug_treatment}</span></p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>Эмоционально-психологический
                        уровень: <span>{speechCard.emotional_and_psychological_level}</span></p>
                      <p>Эмоциональный фон во время занятия
                        ровный, <span>{speechCard.emotional_background_during_class}</span></p>
                      <p>Мотивация и интерес: <span>{speechCard.motivation_and_interest}</span></p>
                      <p>
                        Эмоциональный отклик на эмоцию
                        взрослого: <span>{speechCard.emotional_response_to_adult_emotion}</span></p>
                      <p>
                        Мимические проявления: <span>{speechCard.mimic_manifestations}</span>
                      </p>
                      <p>
                        Базовые эмоции, которые проявлял во время
                        занятия: <span>{speechCard.basic_emotions_that_it_exhibits}</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div className='count-item speech-card-doc__item'>
                  ...
                  <div className='count-list'>
                    ...
                    <p>
                      В пространственно-временной ситуации <span>{speechCard.in_a_time_space_situation}</span>
                    </p>
                  </div>
                </div>
                <div className='count-item speech-card-doc__item'>
                ...
                <div className='count-item speech-card-doc__item'>
                  ...
                  <div className='count-list'>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Уровень понимания речи: <span>{speechCard.speech_comprehension_level}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Уровень сформированности лексикона: <span>{speechCard.level_of_vocabulary_formation}</span>
                      </p>
                      <p>
                        Объем словаря: <span>{speechCard.volume_vocabulary}</span>
                      </p>
                      <p>
                        Системная организация словаря (ассоциативные
                        связи): <span>{speechCard.system_organization_of_dictionary_associative_links}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Уровень сформированности грамматической
                        компетенции: <span>{speechCard.level_of_grammatical_competence_formation}</span>
                      </p>
                      <p>
                        Словоизменительные навыки и
                        умения: <span>{speechCard.inflectional_skills_and_abilities_part_one}</span>
                      </p>
                      <p>
                        Словообразовательные навыки и
                        умения: <span>{speechCard.word_building_skills_and_abilities}</span>
                      </p>
                      <p>
                        Синтаксические навыки и умения: <span>{speechCard.syntactic_skills_and_abilities}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Уровень сформированности фонетико-фонологической
                        компетенции: <span>{speechCard.level_of_formation_of_phonetic_phonological_competence}</span>
                      </p>
                      <p>
                        Состояние фонематического восприятия: <span>{speechCard.state_of_phonemic_perception}</span>
                      </p>
                      <p>
                        Сформированность навыков звукового анализа и
                        синтеза: <span>{speechCard.formation_of_the_skills_of_sound_analysis_and_synthesis}</span>
                      </p>
                      <p>
                        Слоговая структура слова в целом: <span>{speechCard.syllabic_structure_of_a_word}</span>
                      </p>
                      ...
                      <div className='speech-card-doc__sub-in'>
                        ...
                        <p>
                          Дифференцированность вдоха/выдоха и возможность
                          управления: <span>{speechCard.inspiratory_expiratory_differentiation}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='count-list'>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        ...
                        аппарата: <span>{speechCard.articulation_apparatus_structure_game_how_the_mouse_could}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Состояние артикуляционного аппарата: <span>{speechCard.articulation_apparatus_structure}</span>
                      </p>
                      <p>
                        Оральный праксис: <span>{speechCard.oral_praxis}</span>
                      </p>
                      <p>
                        Артикуляционный праксис <span>{speechCard.articulatory_praxis}</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div className='count-item speech-card-doc__item'>
                  ...
                  <div className='count-list'>
                    <div className='speech-card-doc__sub-in'>
                      ...
                      <p>
                        Постуральный контроль спокойного
                        состояния: <span>{speechCard.postural_control_of_calm_state}</span>
                      </p>
                      <p>
                        Билатеральная моторная координация: <span>{speechCard.bilateral_motor_coordination}</span>
                      </p>
                      ...
                      <p>
                        Сформированность моторной имитации: <span>{speechCard.formation_of_motor_imitation}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Моторные функции кистей и пальцев
                        рук: <span>{speechCard.motor_functions_of_hands_and_fingers}</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div className='count-item speech-card-doc__item'>
                  ...
                  <div className='count-list'>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Вербальная память: <span>{speechCard.verbal_memory}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Мышление (вербальный и невербальный
                        интеллект): <span>{speechCard.thinking_verbal_and_non_verbal_intelligence}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Симультанное зрительное восприятие: <span>{speechCard.simultaneous_visual_perception}</span>
                      </p>
                    </div>
                    <div className='count-item speech-card-doc__sub'>
                      <p>
                        Внимание: <span>{speechCard.speech_attention}</span>
                      </p>
                    </div>
                  </div>
                </div>
