            ...
            <div className='speech-card-doc'>
                <div className='speech-card-doc__head'>
                    <div className='speech-card-doc__contact'>
                        ...
                        <a className='speech-card-doc__insta' href='https://www.instagram.com/bibarybaru/'>instagram.com/bibarybaru</a>
                    </div>
                </div>
                <div className='speech-card-doc__content'>
                    ...
                    <div className='speech-card-doc__reserch'>
                        ...
                        <div className='count-list'>
                            <div className='count-item speech-card-doc__item'>
                                ...
                                <div className='count-list'>
                                    <div className='count-item speech-card-doc__sub'>
                                        ...
                                        <p>Пополз на четвереньках в <span>{speechCard.crawled_on_all_fours_into}</span>
                                        </p>
                                    ...
                                    <div className='count-item speech-card-doc__sub'>
                                        ...
                                        <p>Первые короткие фразы в <span>{speechCard.first_short_phrases_in}</span></p>
                                    </div>
                                    <div className='count-item speech-card-doc__sub'>
                            ...
                            <div className='count-item speech-card-doc__item'>
                                <h4 className='speech-card-doc__item-title'>Сформированность представлений об окружающем
                                    мире:</h4>
                                <div className='count-list'>
                                    <p>
